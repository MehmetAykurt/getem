# -*- coding: utf-8 -*-
# Getem E-Kütüphane Güncelleme Motoru
...
EKLENTI_ADI = "Getem E-Kütüphane"

MEVCUT_SURUM = "1.0.0"

GUNCELLEME_LINKI = "https://raw.githubusercontent.com/MehmetAykurt/getem/main/update.json"
...
def eklenti_dosyasini_indir(indirme_linki, yeni_surum, beklenen_sha256=None):
    ...
    try:
        ...
        gecici_klasor = os.path.join(
            tempfile.gettempdir(),
            "mehmet_aykurt_getem_guncelleme"
        )
        ...
        hedef_dosya = os.path.join(
            gecici_klasor,
            f"Getem-E-Kutuphane-{surum_etiketi}.nvda-addon"
        )
